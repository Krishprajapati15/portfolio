...
export default function ProjectsSection() {
  ...
  return (
    <div
      ref={ref}
      id="projects"
      className="w-full p-12 flex justify-between flex-col items-center lg:flex-row lg:items-stretch gap-12 container my-12 text-sm md:text-base"
    >
      <div>
        <div className="sticky top-8 text-center md:text-left">
          ...
          <LaptopAnimation className="w-[400px] -scale-x-100 scale-y-100 mx-auto md:mx-0" />
